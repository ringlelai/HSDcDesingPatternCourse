...
namespace WebMVC.Controllers.Creational
{
    public class BuilderController : Controller
    {
        ...
        public ActionResult NewWeekOvertime()
        {
            WeekOvertimeBuilder builder = new WeekOvertimeBuilder();
            EOfficeDirector<WeekOvertime> director = new EOfficeDirector<WeekOvertime>();
            WeekOvertime form = director.Construct(builder);
            return View(form);
        }

        [HttpPost]
        public ActionResult SaveWeekOvertime(WeekOvertime overtime)
        {
            SaveWeekOvertimeControl uco = new SaveWeekOvertimeControl();
            overtime = uco.Save(overtime);
            return View("NewWeekOvertime", overtime);
        }
    }
}